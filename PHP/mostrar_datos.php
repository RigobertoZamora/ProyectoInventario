    ...
    if($validacion['nombre']  == "")
    {
        ...
        <script>
                Swal.fire({
                    ...
                    window.location = '../HTML/loginn.html'
                });
            </script>
            ";
       ...
       <div class="relativeFecha">
            <form action="bfecha.php" method="post">
                ...
                <input type="submit" name="bfiltro" value="Filtrar" onclick="validarFecha();"/>
            </form>
        </div>
        <!--FILTRO POR N° CUENTA-->
        <div class="relativeCuenta">
            <form action="bregistros.php" method="post">
               ...
               <input type="submit" name="bfiltro" value="Buscar" onclick="validarCuenta();"/>
            </form>
        </div>
