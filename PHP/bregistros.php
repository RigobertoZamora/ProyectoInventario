...
<?php
    ...
    if($filtro == "")
    {
        ...
        $querySelect = "SELECT * FROM registros WHERE No_cuenta=$filtro";
    }

    $consultaCuenta = mysqli_query($conexion, $querySelect);
 ?>
...
<?php
        while($inventario = mysqli_fetch_array($consultaCuenta))
        {
            echo"
                 <tr>
                      <td>".$inventario['id']."</td>
